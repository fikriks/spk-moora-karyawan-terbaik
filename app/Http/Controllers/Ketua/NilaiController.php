...
class NilaiController extends Controller
{
    ...
    return Inertia::render('Ketua/Nilai/Index', [
    ...
    {
        return Inertia::render('Ketua/Nilai/Create', [
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('ketua.nilai.index')->with('success', 'Nilai berhasil ditambahkan.');
        } catch (\Exception $e) {
    ...
    return Inertia::render('Ketua/Nilai/Edit', [
        'nilai' => $nilai,
        'alternatifs' => Alternative::select('id', 'name')->get(),
        'kriterias' => Criterion::select('id', 'name')->get(),
    ]);
