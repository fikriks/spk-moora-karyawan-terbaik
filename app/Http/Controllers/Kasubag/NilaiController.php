...
class NilaiController extends Controller
{
    ...
    return Inertia::render('Kasubag/Nilai/Index', [
    ...
    {
        return Inertia::render('Kasubag/Nilai/Create', [
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('kasubag.nilai.index')->with('success', 'Nilai berhasil ditambahkan.');
        } catch (\Exception $e) {
    ...
    return Inertia::render('Kasubag/Nilai/Edit', [
        'nilai' => $nilai,
        'alternatifs' => Alternative::select('id', 'name')->get(),
        'kriterias' => Criterion::select('id', 'name')->get(),
    ]);
