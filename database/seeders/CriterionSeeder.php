...
class CriterionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $items = [
            ...
            ['code' => 'C3', 'name' => 'Akuntabel', 'type' => 'benefit', 'weight' => 0.15, 'order' => 3],
            ...
            ['code' => 'C7', 'name' => 'Adaptif', 'type' => 'benefit', 'weight' => 0.15, 'order' => 7],
            ['code' => 'C8', 'name' => 'Kolaboratif', 'type' => 'benefit', 'weight' => 0.15, 'order' => 8],
        ];
