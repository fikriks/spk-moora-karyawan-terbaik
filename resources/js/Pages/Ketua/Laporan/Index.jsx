            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-500 max-w-md font-medium leading-relaxed">
                        Analisis komprehensif kinerja pegawai menggunakan metode MOORA untuk pertimbangan manajerial Ketua Pengadilan.
                    </p>
                </div>
            ...
            <div className="bg-white rounded-[32px] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.015)] overflow-hidden">
                <div className="p-8 md:p-12 space-y-12">
                    ...
                    <Section 
                        ...
                        description="Konteks dan tujuan penyusunan laporan untuk pimpinan."
                    >
                        <div className="bg-gray-50/50 rounded-2xl p-6 border border-gray-100/50">
                            <p className="text-sm text-gray-600 leading-relaxed font-medium">
                                Laporan ini disusun sebagai bahan pertimbangan Ketua Pengadilan dalam pelaksanaan fungsi 
                    ...
                    <Section 
                        ...
                        description="Kesimpulan untuk pengambilan keputusan."
                    >
                        <div className="bg-emerald-50/30 rounded-2xl p-6 border border-emerald-100/50">
                            <p className="text-sm text-emerald-700 leading-relaxed font-bold italic">
                                ...
                                bahan pendukung bagi Ketua Pengadilan dalam pengambilan keputusan yang objektif, 
...
LaporanKetuaPengadilan.layout = (page) => (
    <AuthenticatedLayout 
