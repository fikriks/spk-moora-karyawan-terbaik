...
function Index() {
    ...
    function canEdit(role, criteriaName) {
        ...
        // Ketua (non-operator) manages restricted criteria
    ...
    function handleDelete(id, label) {
        confirmAction(`Hapus nilai ${label}?`, () => {
            router.delete(route("ketua.nilai.destroy", id), {
                preserveScroll: true,
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <Link href={route("ketua.nilai.create")} className="inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-emerald-500 text-[13px] font-bold text-white hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-500/20 active:scale-95">
                                        ...
                                        <tr key={item.id} className="group hover:bg-emerald-50/30 transition-colors">
                                            ...
                                            <td className="px-8 py-6 text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    {allowedEdit ? (
                                                        <Link
                                                            href={route("ketua.nilai.edit", item.id)}
