...
export default function Edit() {
    ...
    const submitRoute = route("kasubag.nilai.update", nilai.id);
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-500 max-w-md font-medium leading-relaxed">
                            Perbarui nilai penilaian untuk pegawai <span className="text-emerald-500 font-bold">{nilai?.alternative?.name}</span> pada kriteria <span className="text-emerald-500 font-bold">{nilai?.criteria?.name}</span>.
                        </p>
                    </div>
