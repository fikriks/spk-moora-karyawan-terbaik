    ...
    return (
        <form onSubmit={submit} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative group">
                        ...
                        <select
                            ...
                            className={`block w-full pl-12 pr-10 py-4 bg-gray-50/50 border rounded-2xl text-sm transition-all outline-none appearance-none ${
                    ...
                    {form.errors.alternative_id && (
                        <p className="text-[11px] font-bold text-rose-500 uppercase tracking-wider ml-1 mt-1">
                            {form.errors.alternative_id}
                        </p>
                    )}
                </div>
                ...
                <div className="space-y-2">
                    ...
                    {filteredKriterias.length === 0 && (
                        <p className="text-[11px] font-bold text-amber-500 uppercase tracking-wider ml-1 mt-1 leading-relaxed">
                            Tidak ada kriteria yang tersedia untuk akses Anda saat ini.
                        </p>
                    )}
                    {form.errors.criteria_id && (
                        <p className="text-[11px] font-bold text-rose-500 uppercase tracking-wider ml-1 mt-1">
            ...
            <div className="flex items-center justify-end pt-8 border-t border-gray-50">
                <button
                    type="submit"
                    className="flex items-center gap-2 px-8 py-4 rounded-2xl bg-emerald-500 text-sm font-bold text-white hover:bg-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-emerald-500/20 active:scale-95"
