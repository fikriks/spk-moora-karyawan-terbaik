            ...
            <table className="w-full text-sm text-left">
                <thead>
                    <tr className="bg-gray-50/80 border-b border-gray-100">
                        <th className="px-6 py-4 font-bold text-gray-900 uppercase tracking-wider text-[11px] bg-gray-50/50 sticky left-0 z-10 border-r border-gray-100 whitespace-nowrap">
                            Alternatif
                        </th>
                        {criteriaIds.map((cid) => (
                ...
                <tbody className="divide-y divide-gray-50">
                    {Object.entries(data).map(([altId, values]) => (
                        <tr key={altId} className="hover:bg-emerald-50/30 transition-colors group">
                            <td className="px-6 py-4 font-bold text-gray-600 bg-white group-hover:bg-emerald-50/30 transition-colors sticky left-0 z-10 border-r border-gray-100 text-center whitespace-nowrap">
                            ...
                            {criteriaIds.map((cid) => (
                                <td key={cid} className="px-6 py-4 text-center font-medium text-gray-600 border-r border-gray-100 last:border-r-0 whitespace-nowrap">
